...
import org.example.wan.android.databinding.ActivitySettingBinding
        ...
        binding.llLog.onClick {
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                try {
                    ...
                    // Caused by: java.io.FileNotFoundException: /storage/emulated/0/Android/data/org.example.wan.android/files/crash: open failed: ENOENT (No such file or directory)
                    // 没有报错文件
                    toast("应用似乎正在稳定运行")
                    return@launch
                }
