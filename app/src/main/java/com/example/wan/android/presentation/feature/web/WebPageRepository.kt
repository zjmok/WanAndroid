package com.example.wan.android.presentation.feature.web
...
import com.example.wan.android.util.dateFormat
import com.example.wan.android.util.fromJson
...
//                return@edit
                // 读取当前的 WebPage 列表
                val key = if (isBookmark) com.example.wan.android.presentation.feature.web.WebPageRepository.Companion.BOOKMARK_KEY else com.example.wan.android.presentation.feature.web.WebPageRepository.Companion.HISTORY_KEY
                val json = data[key]
